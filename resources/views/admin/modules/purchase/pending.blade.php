                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    @foreach ($pending as $key => $purchase)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            ...
                                            <td style="width: 100px">
                                                @if (! $purchase->status)
                                                    <form style="display: inline-block" method="POST" action="{{ route('purchase.update', $purchase->id) }}">
                                                        @csrf
                                                        @method('put')
                                                        <a href="#" onclick="event.preventDefault();
                                                        this.closest('form').submit();"
                                                            class="btn btn-outline-success btn-sm edit" title="Delete">
