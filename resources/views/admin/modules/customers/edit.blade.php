                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">{{ __('Add new customers effortlessly with a streamlined form for quick integration.') }}</p>
                            <form method="POST" action="{{ route('customer.update', $customer->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="mobile_no" type="text" placeholder="Customer mobile number"
                                            id="mobile" value={{ $customer->mobile_no }}>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <button class="btn btn-dark waves-effect waves-light text-uppercase" type="submit">{{ __('Update Customer') }}</button>
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
